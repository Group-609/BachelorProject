...
public class DefeatedEnemiesCountCondition : ICondition
{
    ...
    private static readonly float[] dpgValues = new float[] { 0.5f, 0.75f, 1f, 1.25f, 1.5f }; // defeated enemy count difference, by which the DDAA's additive values would be mapped
